...
class MessageViewController: JSQMessagesViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let titleLabel: UILabel = {
        let title = UILabel(frame: CGRect(x: 50, y: 10, width: 140, height: 30))
    ...
    let subtitleLabel: UILabel = {
       let subTitle = UILabel(frame: CGRect(x: 40, y: 30, width: 140, height: 0))
    ...
    func loadUserDefaults() {
     ...
     func checkForBackgroundImage() {
         ...
         if userDefaults.object(forKey: kBACKGROUNDIMAGE) != nil {
            ...
            let imageView = UIImageView(frame: self.view.frame.self)
