...
class FirebaseUserListener {
    ...
    //MARK: - Register
    func registerUserWith(firstName: String, lastName: String, email: String, language: String, password: String, completion: @escaping (_ error: Error?) -> Void) {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { (authDataResult, error) in
            ...
            if error == nil {
                ...
                if authDataResult?.user != nil {
                    ...
                    let user = User(id: authDataResult!.user.uid, firstName: firstName, lastName: lastName, email: email, language: language, pushId: "", avatarLink: "")
